...
class Accuracy(PerformanceMeasure):
    ...
    def reset(self) -> None:
        ...
        It resets counters or variables used to track the number of correct predictions and totalAcc predictions.
        """
    ...
    def per_class_accuracy(self) -> float:
        ...
        per_class_accuracy = [
            ...
            for correct, total in zip(per_class_correct_count, per_class_total_count)
        ]
